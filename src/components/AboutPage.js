        ...
        return (
            <ScrollView style={{
                    ...
                    <Text style={{
                        ...
                        textAlign: 'center',
                        lineHeight: 20
                    }}>- An Innovative venture by Government of West Bengal in the form of a Fabulous Food Festival.</Text>
                    <Text style={{
                        color: '#012f51',
                        fontSize: 14,
                        margin: 15,
